# PersistentWebApp
PersistentWebApp for maven web app
...
----------------------------------------------------------------------------------------------------------------------------------
 mvn archetype:generate -DgroupId=com.javatpoint -DartifactId=PersistentWebApp -DarchetypeArtifactId=maven-archetype-webapp -DinteractiveMode=false
 ...
 http://<host-name>:<portnumber>/projectname, for example: http://localhost:8080/PersistentWebApp
